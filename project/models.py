...
from project.constants import PROCESS_TYPE_CHOICES, HTTP_METHOD_CHOICES, PROJECT_STATUS_CHOICES, ProjectStatus
from utils.constants import HTTPMethod, ProcessType


class Project(models.Model):
    proj_id = models.AutoField('项目id', primary_key=True)
